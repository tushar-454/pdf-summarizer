/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: ce49a5eeaf4a9ba2ae3e71f5cf98911d)
...
declare namespace Cloudflare {
	...
	interface Env {
		pdf_summarizer: Hyperdrive;
		pdf_summarizer_queue: Queue;
		AI: Ai;
		...
		WORKER_SELF_REFERENCE: Service<typeof import("./consumer").default>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
